...
defined('ROOT_PATH')    or define('ROOT_PATH',      __DIR__.'/../'); // 项目root目录 邹广圆 20170215
...
defined('RUNTIME_PATH') or define('RUNTIME_PATH',   ROOT_PATH.'Runtime/');   // 系统运行时目录 // 邹广圆 20170215
...
defined('VENDOR_PATH')  or define('VENDOR_PATH',    THINK_PATH.'Vendor/'); // 第三方类库目录
defined('COMMON_PATH')  or define('COMMON_PATH',    APP_PATH.'Common/'); // 应用公共目录
defined('CONF_PATH')    or define('CONF_PATH',      ROOT_PATH.'Config/'); // 应用配置目录 邹广圆 20170215
...
defined('CONF_EXT')     or define('CONF_EXT',       '.ini'); // 配置文件后缀 邹广圆 20170215
